...
inputFileName = "App-Output 1_Life_Track_White_Stork_SW_Germany__Time_Lag_Between_Locations__2022-07-13_10-08-51.rds" #important to set to NULL for movebank-download
...
args[["last_loctime"]] <- "2000-01-01T21:00:00Z" #UTC! - after that at least gap of X>1 hours, if NULL then no systematic gap
